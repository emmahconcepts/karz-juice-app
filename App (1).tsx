...
// ── Root content — route before DashboardLayout for public pages ──────────────
function AppContent() {
  ...
  // Public: QR receipt verification  — /verify/:receiptNumber
  if (pathname.startsWith("/verify/")) return <ReceiptVerifyPage />;

  // All other routes — auth-gated dashboard
  return (
    <DashboardLayout>
      <DashboardRouter />
    </DashboardLayout>
